...
@Component({
  selector: 'app-devolucion-fondo',
  templateUrl: './devolucion-fondo.component.html',
  styleUrls: ['./devolucion-fondo.component.css']
})
export class DevolucionFondoComponent implements OnInit {
  ...
  onSubmit(){
    ...
    this._superService.devolverFondo(this.cajero,this.ngusuario,this.ngpassword).subscribe(
      result => {
