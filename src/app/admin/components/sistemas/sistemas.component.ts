...
export class SistemasComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //this.asignarCat(this.SistemaSeleccionado);
    ...
    this._adminService.getSistemas().subscribe(
      result => {
        ...
        this.getsistemas =
          result.respuesta; /**Asignamos los valores obtenidos de la consulta a nuestra variable de tipo Arreglo */
    ...
    this._adminService.altaSistemas(this.sistemas).subscribe(
      ...
      error => {
        ...
        if (error.status == "400") {
          ...
          this.SistemaSeleccionado = new Sistema(
            0,
            "",
            ""
          ); /**INICIALIZAR EL CLONADO */
          this.sistemas = new Sistema(0, "", ""); /**INICIALIZAR EL CLONADO */
  ...
  selectcheck2(i) {
    this.SistemaSeleccionado.id = this.getsistemas[i].id;
  ...
  asignarCat(i) {
    //this.ngOnInit();
    this.SistemaSeleccionado.nombre = this.getsistemas[i].nombre;
    this.SistemaSeleccionado.descripcion = this.getsistemas[i].descripcion;
    ...
    console.log(
      JSON.stringify(this.getsistemas[i])
    ); /**Este es el dato (sistema a eliminar) */
...
*/
  modificarSistema() {
    ...
    this._adminService.modificarSistema(this.SistemaSeleccionado).subscribe(
      result => {
        ...
        $("#TablaSistemas")
          .dataTable()
          .fnDestroy(); /**UN INTENTO DE REINICIAR LA TABLA Y LLAMAR LOS MÉTODOS PRINCIPALES */
        this.ngOnInit();
        //this.productos = null;
      },
      error => {
  ...
  clear() {
    ...
    this.SistemaSeleccionado = new Sistema(0,"",""); /**CUANDO SE MANDAN LOS DATOS MODIFICADOS, REINICIAMOS */
    console.log(
      "MEMOOOOO ESTOS SON LOS NUEVOS DATOS DESPUES DE AGREGAR UNO NUEVOOOOOO"
    );
    console.log(JSON.stringify(this.SistemaSeleccionado));
    /**DAR DE ALTA SISTEMAS  MET=POST*/
  }
