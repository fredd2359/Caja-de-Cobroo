...
(function(h) {
    ...
    function ob(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<div class = "input-group"><input type="search" class="' + b.sFilterInput + '"><i class="fa fa-search input-group-addon" aria-hidden="true" ></i> </div>',
            j = d.sSearch,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "No hay registros para mostrar aún.",
            sInfo: "Registro _START_ de _END_, total: _TOTAL_",
            sInfoEmpty: "No hubo resultados",
            sInfoFiltered: "(Filtrado a partir de _MAX_ registros)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Mostrar _MENU_ registros",
            sLoadingRecords: "Cargando, espere un momento por favor...",
